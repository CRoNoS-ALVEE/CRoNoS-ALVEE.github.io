...
interface ChatbotLoggedInProps {
    user: User
    onLogout: () => void
}

export default function ChatbotLoggedIn({ user, onLogout }: ChatbotLoggedInProps) {
    ...
    return (
        <div className={styles.container}>
            ...
            >
                <div className={styles.sidebarContent}>
                    ...
                    <div className={styles.sidebarBottom}>
                        ...
                        <button onClick={onLogout} className={styles.sidebarNavItem}>
                            <LogOut size={18} />
                            <span>Logout</span>
                        </button>
                    </div>
            ...
            {/* Main Chat Area */}
            <div className={`${styles.mainChat} ${styles.loggedInLayout} ${(isSidebarHovered || isSidebarPinned) && !isMobile ? styles.withSidebar : ''}`}>
