    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            const responses = [
                ...
                "Sign up to get personalized doctor recommendations in your area.",
                "I can provide general health guidance. For detailed analysis and local doctor suggestions, please create an account.",
                "For comprehensive health analysis and personalized recommendations, please create an account."
            ]
